...
export const SUBSCRIPTION_PRESETS: SubscriptionPreset[] = [
  ...
  { id: "kimi", name: "Kimi", cycle: "yearly", color: "#111827" },
  { id: "perplexity", name: "Perplexity Pro", cycle: "monthly", color: "#20B8CD" },
  { id: "gemini", name: "Gemini Advanced", cycle: "monthly", color: "#4E87F7" },
  { id: "midjourney", name: "Midjourney", cycle: "monthly", color: "#000000" },
  { id: "lightroom", name: "Lightroom", cycle: "yearly", color: "#001E36" },
  { id: "creativecloud", name: "Adobe Creative Cloud", cycle: "monthly", color: "#EB1000" },
  { id: "canva", name: "Canva Pro", cycle: "yearly", color: "#7D2AE8" },
  { id: "windy", name: "Windy", cycle: "yearly", color: "#D21849" },
  { id: "notion", name: "Notion", cycle: "yearly", color: "#000000" },
  { id: "microsoft365", name: "Microsoft 365", cycle: "yearly", color: "#D83B01" },
  { id: "dropbox", name: "Dropbox Plus", cycle: "yearly", color: "#0061FF" },
